...
; amixer -c 1 -D pulse set Master toggle
(xbindkey '("XF86AudioMute") "amixer -D pulse set Master toggle")
(xbindkey '("XF86AudioRaiseVolume") "~/.dotfiles/x1/bin/vol-up")
(xbindkey '("XF86AudioLowerVolume") "~/.dotfiles/x1/bin/vol-down")
; (xbindkey '("XF86Launch1") "~/.togglemak")
